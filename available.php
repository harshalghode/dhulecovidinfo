...
<button class='btn border border-success' style='background-color:yellow'>Available</button>
</a>
...
<button class='btn border border-warning'>ICU With Ventilator</button>
</a>
