...
<ul class="navbar-nav ml-auto mr-auto">
    ...
    <li class="nav-item active pl-2">
              <a href="tiffin.php" class="nav-link btn btn-light  text-dark"><i class="fas fa-box"></i> Tiffin</a>
    </li>
...
<a href="index.php">
<button class='btn border border-warning'>All Data</button>
</a>
<a href="available.php">
<button class='btn border border-warning'>Available</button>
</a>
<a href="withoutoxygen.php">
<button class='btn border border-warning'>Without Oxygen</button>
</a>
<a href="withoxygen.php">
<button class='btn border border-warning'>With Oxygen</button>
</a>
<a href="icu.php">
<button class='btn border border-warning'>ICU</button>
</a>
<a href="icuwithven.php">
<button class='btn border border-success' style='background-color:yellow'>ICU With Ventilator</button>
</a>
